...
import { MainPageProduct } from '@/payload-types';
import {
  Carousel,
  CarouselContent,
  CarouselItem,
                ...
                <Card className="bg-background/10 rounded-3xl py-3 backdrop-blur-md sm:w-1/2 xl:w-1/3">
                  <CardContent>
                    <p className="text-white">
                      <b>SmartEyes V1 Wayfarer</b> — стильные умные очки,
                      которые станут вашим незаменимым спутником в путешествиях,
                      прогулках и повседневной жизни.
                    </p>
                  </CardContent>
                </Card>
